...
class LogedinProject extends StatefulWidget{
  const LogedinProject() : super();
  @override
  _LogedinProject createState() => _LogedinProject();
}

class _LogedinProject extends State<LogedinProject>{
...
)),),Spacer(flex: 5,),Flexible(flex: 6,child: Padding(padding: EdgeInsets.only(left: MediaQuery.of(context).size.width * 0.10,right: MediaQuery.of(context).size.width * 0.14,),child: Container(width: MediaQuery.of(context).size.width * 0.649,height: MediaQuery.of(context).size.height * 0.054,child: Align(alignment: Alignment(0.00, 0.00),child: AutoSizeText(
'Select Project',
style: TextStyle(
fontFamily: 'Roboto',
fontSize: 12.0,
...
),))),),Spacer(flex: 12,),Flexible(flex: 5,child: Padding(padding: EdgeInsets.only(left: MediaQuery.of(context).size.width * 0.78,),child: Image.asset('assets/images/209_450.png', width: MediaQuery.of(context).size.width * 0.105,height: MediaQuery.of(context).size.height * 0.046,)),),]),)),), 
);
  }
